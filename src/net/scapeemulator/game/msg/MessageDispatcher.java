...
import net.scapeemulator.game.msg.handler.CameraMessageHandler;
import net.scapeemulator.game.msg.handler.ChatMessageHandler;
import net.scapeemulator.game.msg.handler.ClickMessageHandler;
import net.scapeemulator.game.msg.handler.CommandMessageHandler;
import net.scapeemulator.game.msg.handler.DisplayMessageHandler;
import net.scapeemulator.game.msg.handler.EquipItemMessageHandler;
import net.scapeemulator.game.msg.handler.FlagsMessageHandler;
import net.scapeemulator.game.msg.handler.FocusMessageHandler;
import net.scapeemulator.game.msg.handler.GroundItemOptionMessageHandler;
import net.scapeemulator.game.msg.handler.IdleLogoutMessageHandler;
import net.scapeemulator.game.msg.handler.InterfaceClosedMessageHandler;
import net.scapeemulator.game.msg.handler.PingMessageHandler;
import net.scapeemulator.game.msg.handler.PlayerOptionMessageHandler;
import net.scapeemulator.game.msg.handler.RegionChangedMessageHandler;
import net.scapeemulator.game.msg.handler.RemoveItemMessageHandler;
import net.scapeemulator.game.msg.handler.SceneRebuiltMessageHandler;
import net.scapeemulator.game.msg.handler.SequenceNumberMessageHandler;
import net.scapeemulator.game.msg.handler.SwapItemsMessageHandler;
import net.scapeemulator.game.msg.handler.WalkMessageHandler;
